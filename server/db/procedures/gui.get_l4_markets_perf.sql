...
BEGIN  
   ...
   ORDER BY case when in_ORDER_BY = 'l4_market_name' and in_ORDER_DIR = 'asc'  then l4_market_name end asc 
          , case when in_ORDER_BY = 'l4_market_name' and in_ORDER_DIR = 'desc' then l4_market_name end desc
          , l4_market_name ASC
