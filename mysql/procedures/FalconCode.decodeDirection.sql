DROP PROCEDURE IF EXISTS FalconCode.decodeDirection;

DELIMITER $$
$$
CREATE FUNCTION FalconCode.decodeDirection(
   azimuth DOUBLE
)
RETURNS varchar(2)
no sql
...
GRANT EXECUTE ON FUNCTION FalconCode.decodeDirection TO falcon;